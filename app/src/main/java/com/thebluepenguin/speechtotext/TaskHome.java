    ...
    public void onResume() {
        ...
        if (isDelete) {
            Snackbar snackbar = Snackbar
                    .make(findViewById(R.id.coordinatorLayout), name + " Has Been Deleted", Snackbar.LENGTH_LONG)
                    .setAction("Undo", mOnClickListener = new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            mydb.insertContact(name, dateStr);
                            populateData();
                        }
                    });
